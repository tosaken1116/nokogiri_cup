...
export type UploadArticleMutation = {
    __typename?: "mutation_root";
    insertArticle?: {
        __typename?: "ArticleMutationResponse";
        returning: Array<{ __typename?: "Article"; id: number }>;
    } | null;
};

export const UploadArticleDocument = {
    kind: "Document",
    definitions: [
        {
            kind: "OperationDefinition",
            operation: "mutation",
            name: { kind: "Name", value: "uploadArticle" },
            variableDefinitions: [
                {
            ...
            selectionSet: {
                ...
                selections: [
                    {
                        kind: "Field",
                        name: { kind: "Name", value: "insertArticle" },
                        arguments: [
                            {
                                kind: "Argument",
    ...
    UploadArticleMutation,
    UploadArticleMutationVariables
>;
