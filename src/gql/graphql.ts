...
export type GetArticleByIdQuery = { __typename?: 'query_root', article: Array<{ __typename?: 'Article', authorId: string, caption: string, createdAt: any, fileId?: string | null, githubUrl?: string | null, id: number, title: string }> };
